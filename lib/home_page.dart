...
import 'package:bingogamehousie/sound_player.dart';
import 'package:bingogamehousie/theme_color.dart';
import 'package:bingogamehousie/setting_page.dart';
import 'package:bingogamehousie/main.dart';
import 'package:bingogamehousie/theme_mode_number.dart';
import 'package:bingogamehousie/parse_locale_tag.dart';
import 'package:bingogamehousie/card_grid.dart';
...
class _MainHomePageState extends State<MainHomePage> with TickerProviderStateMixin {
  ...
  void _onSpinCompleted(int ballIndex) async {
    ...
    Future.delayed(Duration(milliseconds: 2000), () {
      _cardGridUpdateSign = ballIndex + 1;
    });
  }
              ...
              child: LayoutBuilder(
                builder: (context, constraints) {
                  ...
                  return SingleChildScrollView(
                    padding: const EdgeInsets.only(left: 4, right: 4, top: 0, bottom: 100),
                    child: Column(
                      ...
                      children: [
                        ...
                        if (wideLayout)
                          Row(
                            ...
                            children: [
                              Expanded(child: CardGrid(cardNumber: 1, cardGridUpdateSign: _cardGridUpdateSign)),
                              Expanded(child: CardGrid(cardNumber: 2, cardGridUpdateSign: _cardGridUpdateSign)),
                            ],
                          )
                        else ...[
                          CardGrid(cardNumber: 1, cardGridUpdateSign: _cardGridUpdateSign),
                          CardGrid(cardNumber: 2, cardGridUpdateSign: _cardGridUpdateSign),
                        ],
                        if (wideLayout)
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Expanded(child: CardGrid(cardNumber: 3, cardGridUpdateSign: _cardGridUpdateSign)),
                              Expanded(child: CardGrid(cardNumber: 4, cardGridUpdateSign: _cardGridUpdateSign)),
                            ],
                          )
                        else ...[
                          CardGrid(cardNumber: 3, cardGridUpdateSign: _cardGridUpdateSign),
                          CardGrid(cardNumber: 4, cardGridUpdateSign: _cardGridUpdateSign),
                        ],
                        if (wideLayout)
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Expanded(child: CardGrid(cardNumber: 5, cardGridUpdateSign: _cardGridUpdateSign)),
                              Expanded(child: CardGrid(cardNumber: 6, cardGridUpdateSign: _cardGridUpdateSign)),
                            ],
                          )
                        else ...[
                          CardGrid(cardNumber: 5, cardGridUpdateSign: _cardGridUpdateSign),
                          CardGrid(cardNumber: 6, cardGridUpdateSign: _cardGridUpdateSign),
                        ],
                        if (wideLayout)
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Expanded(child: _buildProgressCard(l)),
