...
import 'package:bingogamehousie/l10n/app_localizations.dart';
import 'package:bingogamehousie/ad_banner_widget.dart';
import 'package:bingogamehousie/ad_manager.dart';
import 'package:bingogamehousie/ad_ump_status.dart';
import 'package:bingogamehousie/const_value.dart';
import 'package:bingogamehousie/loading_screen.dart';
import 'package:bingogamehousie/model.dart';
import 'package:bingogamehousie/text_to_speech.dart';
...
class _SettingPageState extends State<SettingPage> {
  ...
  bool _isFirst = true;
  //
  TextEditingController _cardSubjectController1 = TextEditingController();
  TextEditingController _cardSubjectController2 = TextEditingController();
  TextEditingController _cardSubjectController3 = TextEditingController();
  TextEditingController _cardSubjectController4 = TextEditingController();
  TextEditingController _cardSubjectController5 = TextEditingController();
  TextEditingController _cardSubjectController6 = TextEditingController();
  ...
  void _initState() async {
    ...
    _refreshConsentInfo();
    //
    _cardSubjectController1 = TextEditingController(text: Model.cardSubject1);
    _cardSubjectController2 = TextEditingController(text: Model.cardSubject2);
    _cardSubjectController3 = TextEditingController(text: Model.cardSubject3);
    _cardSubjectController4 = TextEditingController(text: Model.cardSubject4);
    _cardSubjectController5 = TextEditingController(text: Model.cardSubject5);
    _cardSubjectController6 = TextEditingController(text: Model.cardSubject6);
  ...
  Future<void> _onApply() async {
    ...
    if (_resetCard) {
      await Model.resetCard(1);
      await Model.resetCard(2);
      await Model.resetCard(3);
      await Model.resetCard(4);
      await Model.resetCard(5);
      await Model.resetCard(6);
    }
    await Model.setCardSubject1(_cardSubjectController1.text);
    await Model.setCardSubject2(_cardSubjectController2.text);
    await Model.setCardSubject3(_cardSubjectController3.text);
    await Model.setCardSubject4(_cardSubjectController4.text);
    await Model.setCardSubject5(_cardSubjectController5.text);
    await Model.setCardSubject6(_cardSubjectController6.text);
  ...
  InputDecoration _inputDecoration() {
    ...
    return InputDecoration(
      isDense: true,
      filled: true,
      fillColor: _themeColor.cardColor,
      contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
      border: OutlineInputBorder(
        borderRadius: radius,
        borderSide: BorderSide(color: _themeColor.backColor, width: 1),
      ),
    );
  }

  Widget _buildCardSubject(AppLocalizations l) {
    return Card(
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextField(
                        controller: _cardSubjectController1,
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 6),
                      child: TextField(
                        controller: _cardSubjectController2,
                        keyboardType: TextInputType.text,
                        decoration: _inputDecoration(),
                      ),
                    ),
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 6),
                      child: TextField(
                        controller: _cardSubjectController3,
                        keyboardType: TextInputType.text,
                        decoration: _inputDecoration(),
                      ),
                    ),
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 6),
                      child: TextField(
                        controller: _cardSubjectController4,
                        keyboardType: TextInputType.text,
                        decoration: _inputDecoration(),
                      ),
                    ),
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 6),
                      child: TextField(
                        controller: _cardSubjectController5,
                        keyboardType: TextInputType.text,
                        decoration: _inputDecoration(),
                      ),
                    ),
                ...
                TableRow(
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 6),
                      child: TextField(
                        controller: _cardSubjectController6,
                        keyboardType: TextInputType.text,
                        decoration: _inputDecoration(),
                      ),
                    ),
